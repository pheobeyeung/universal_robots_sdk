...
public class CloseProgramNodeView implements SwingProgramNodeView<CloseProgramNodeContribution> {
	...
	CloseProgramNodeView(Style style) {
		this.style = style;
	}

	@Override
	public void buildUI(JPanel jPanel, final ContributionProvider<CloseProgramNodeContribution> provider) {
