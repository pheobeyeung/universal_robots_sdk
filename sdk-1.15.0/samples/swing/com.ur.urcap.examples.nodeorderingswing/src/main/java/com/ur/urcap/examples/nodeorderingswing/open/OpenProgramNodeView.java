...
public class OpenProgramNodeView implements SwingProgramNodeView<OpenProgramNodeContribution> {
	...
	OpenProgramNodeView(Style style) {
		this.style = style;
	}

	@Override
	public void buildUI(JPanel jPanel, final ContributionProvider<OpenProgramNodeContribution> provider) {
