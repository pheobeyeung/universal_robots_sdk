...
;;
2)
    softwareVersion=5.23.0
    compatibilitytext="Only compatible with e-Series"
    cb3compatible=false
    eseriescompatible=true
    API_VERSIONS+=( 1 "1.18.0 (PolyScope SW ${softwareVersion} or newer required)" )
    API_VERSIONS+=( 2 "1.17.0 (PolyScope SW 5.21.0 or newer required)" )
    API_VERSIONS+=( 3 "1.16.0 (PolyScope SW 5.20.0 or newer required)" )
    API_VERSIONS+=( 4 "1.15.0 (PolyScope SW 5.18.0 or newer required)" )
    API_VERSIONS+=( 5 "1.14.0 (PolyScope SW 5.15.0 or newer required)" )
    API_VERSIONS+=( 6 "1.13.0 (PolyScope SW 5.11.0 or newer required)" )
    API_VERSIONS+=( 7 "1.12.0 (PolyScope SW 5.10.0 or newer required)" )
    API_VERSIONS+=( 8 "1.11.0 (PolyScope SW 5.9.0 or newer required)" )
    API_VERSIONS+=( 9 "1.10.0 (PolyScope SW 5.8.0 or newer required)" )
    API_VERSIONS+=( 10 "1.9.0 (PolyScope SW 5.6.0 or newer required)")
    API_VERSIONS+=( 11 "1.8.0 (PolyScope SW 5.5.0 or newer required)" )
    API_VERSIONS+=( 12 "1.7.0 (PolyScope SW 5.4.0 or newer required)" )
    API_VERSIONS+=( 13 "1.6.0 (PolyScope SW 5.3.0 or newer required)" )
    API_VERSIONS+=( 14 "1.5.0 (PolyScope SW 5.2.0 or newer required)" )
    API_VERSIONS+=( 15 "1.4.0 (PolyScope SW 5.1.0 or newer required)" )
    API_VERSIONS+=( 16 "1.3.0 (PolyScope SW 5.0.0 or newer required)" )
    API_VERSIONS+=( 17 "1.2.56 (PolyScope SW 5.0.0 or newer required)" )
    API_VERSIONS+=( 18 "1.1.0 (PolyScope SW 5.0.0 or newer required)" )
    API_VERSIONS+=( 19 "1.0.0 (PolyScope SW 5.0.0 or newer required)" )
;;
3)
