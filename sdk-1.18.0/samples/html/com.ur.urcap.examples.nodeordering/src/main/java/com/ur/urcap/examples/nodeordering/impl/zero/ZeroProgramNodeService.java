package com.ur.urcap.examples.nodeordering.impl.zero;
...
public class ZeroProgramNodeService implements ProgramNodeService, ProgramNodeServiceConfigurable {

	private final double DISPLAY_ORDER_ID = 3;
	...
	public ProgramNodeContribution createNode(URCapAPI api, DataModel model) {
		return new ZeroProgramNodeContribution(DISPLAY_ORDER_ID);
	}
