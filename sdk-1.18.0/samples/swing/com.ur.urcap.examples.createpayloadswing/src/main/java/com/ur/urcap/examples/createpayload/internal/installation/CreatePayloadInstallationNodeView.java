package com.ur.urcap.examples.createpayload.internal.installation;
...
public class CreatePayloadInstallationNodeView implements SwingInstallationNodeView<CreatePayloadInstallationNodeContribution> {
	...
	private static final String X_COORDINATE_TXT = "CX";
	private static final String Y_COORDINATE_TXT = "CY";
	private static final String Z_COORDINATE_TXT = "CZ";
	...
	public static final String CREATE_PAYLOAD = CreatePayloadInstallationNodeView.class.getSimpleName() + "CREATE_PAYLOAD";
	public static final String DELETE_PAYLOAD = CreatePayloadInstallationNodeView.class.getSimpleName() + "DELETE_PAYLOAD";
	...
	private JButton createDeletePayloadButton() {
		...
		deleteButton.setName(DELETE_PAYLOAD);
	...
	private JButton createCreatePayloadButton() {
		...
		createButton.setName(CREATE_PAYLOAD);
	...
	private Box createLabelInputField(String label, String unit, final JTextField inputField, MouseAdapter mouseAdapter) {
		...
		inputField.setName(CreatePayloadInstallationNodeView.class.getSimpleName() + label);
